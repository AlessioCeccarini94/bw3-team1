...
import { BsBookmarkFill, BsPeopleFill, BsNewspaper, BsCalendarEvent, BsPersonCircle } from 'react-icons/bs';
import { GiTakeMyMoney } from "react-icons/gi";

const LeftSidebar = () => {
  return (
    <div className="sticky-top pt-3 ms-5"> {/* Rende la sidebar "appiccicosa" quando scrolli */}
      
      {/* 1. Card Profilo Utente */}
      <Card className="mb-2 shadow-sm w-75">
        <div 
          className="position-relative" 
          style={{ height: '80px', backgroundColor: '#9e9e9e', borderTopLeftRadius: '0.25rem', borderTopRightRadius: '0.25rem' }} 
        >
          {/* Sfondo Placeholder */}
        </div>
        ...
        <Card.Body className="p-0">
          <div className="pt-2"> 
            ...
            >
              ...
              <BsPersonCircle size={68} color="#757575" className="position-relative" style={{ top: '-1px' }} />
              ...
              <Button 
                ...
                style={{ width: '24px', height: '24px', bottom: '-4px', right: '-4px', zIndex: '10' }} 
              >
                +
              </Button>
            </div>
        ...
        <Card.Body className="p-3">
          <div className="d-flex justify-content-between">
            <div>
              ...
              <span className="d-block text-secondary ">Espandi la tua rete</span>
            </div>
      ...
      <Card className="mb-2 shadow-sm w-75">
        <Card.Body className="p-3">
          <span className="d-block text-secondary small">Una rete più smart con Premium</span>
          <p className="fw-bold mb-0 mt-1">
            <span role="img" aria-label="premium" className="me-2">
              <span style={{ fontSize: '1.2rem' }}><GiTakeMyMoney /></span>
            </span>
            Prova per 0 EUR
          </p>
        </Card.Body>
