...
function SinglePost(props) {
      ...
      <Card.Body className="pt-0 pb-2">
        <Row className="align-items-center mb-2">
          ...
          <Col xs="auto">
            ...
            <span className="me-2 fs-6"><FcLike/></span>  
            <span className="me-2 fs-6"><FaHandsBubbles/></span>
            <span className="me-2 fs-6"><FaArrowsRotate/></span>
  ...
  <Col className="text-center p-0">
    ...
    >
      <span className="me-2 fs-5"><i className='bbi bi-heart'></i></span> 
  ...
  <Col className="text-center p-0">
    <Button 
      ...
      style={{ padding: '8px 4px' }}
    >
      <span className="me-2 fs-5"> <i className='bi bi-chat'></i> </span> 
  ...
  <Col className="text-center p-0">
    <Button 
      ...
      style={{ padding: '8px 4px' }}
    >
      <span className="me-2 fs-5"><i className='bi bi-repeat'></i></span> 
  ...
  <Col className="text-center p-0">
    <Button 
      ...
      style={{ padding: '8px 4px' }}
    >
     <span className="me-2 fs-5"><i className="bi bi-send"></i></span> 
